...
file_put_contents("debug_sql.txt", "ID=$karyawan_id; Jenis=$jenis_absensi; Lat=$latitude; Lng=$longitude; Lokasi=$lokasi");
...
$stmt->bind_param("issdds", $karyawan_id, $jenis_absensi, $latitude, $longitude, $lokasi);
